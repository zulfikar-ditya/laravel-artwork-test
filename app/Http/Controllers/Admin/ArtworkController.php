...
use App\Http\Requests\Admin\Artwork\UpdateArtworkRequest;
...
class ArtworkController extends Controller
{
    ...
    {
        // $this->authorize('viewAny', App\Models\Artwork::class);
    ...
    public function store(StoreArtworkRequest $request, ArtworkServiceInterface $artworkService)
    {
        ...
        try {
            $artwork = $artworkService->create($request);
        } catch (\Throwable $th) {
            DB::rollBack();
    ...
    public function update(UpdateArtworkRequest $request, Artwork $artwork, ArtworkServiceInterface $artworkService)
    {
        ...
        try {
            $artworkService->update($request, $artwork);
        } catch (\Throwable $th) {
            DB::rollBack();
            Log::error($th->getMessage());
