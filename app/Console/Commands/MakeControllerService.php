...
class MakeControllerService extends GeneratorCommand
{
    ...
    protected function buildModelReplacements(array $replace)
    {
        ...
        if ($this->option('test')) {
            ...
            try {
                $this->call('app:make-controller-service-test-command', [
    ...
    {
        return $this->option('api') ? base_path('stubs/controller-service-api.stub') : base_path('stubs/controller-service.stub');
    }
